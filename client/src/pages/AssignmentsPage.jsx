...
const AssignmentsPage = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      setItems(Array.isArray(assignmentsResponse.data) ? assignmentsResponse.data : assignmentsResponse.data?.rows || []);
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionCard title="Assignments" subtitle="Track assignment delivery, PDFs, and student submissions.">
        ...
        {loading ? (
          <ContentState tone="loading" title="Loading assignments" description="The latest assignment list is being prepared." />
        ) : error && !items.length ? (
          <ContentState tone="error" title="Unable to load assignments" description={error} />
        ) : !filteredItems.length ? (
          <ContentState tone="empty" title="No assignments found" description="Try a different search or create a new assignment to get started." />
        ) : (
